...
- The 5-byte timestamp field **MUST** be a 40-bit unsigned integer encoded in big-endian order, capable of representing 0..36^7−1, ensuring chronological coverage up to ~year **4453**.
...
- Custom alphabets, separators, or prefixes **MUST NOT** be introduced by compliant generators.
